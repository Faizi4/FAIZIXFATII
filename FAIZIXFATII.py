...
while loop == 'true':
    ...
    print '\x1b[1;97m'
    print '\x1b[1;97m '
    username = raw_input('              \x1b[1;94mTOOL USERNAME: FAIZI')
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY FAIZIXFATI\xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print 47 * '-'
    print ''
    print " _____     _     _                                |  ___|_ _(_)___(_)                               | |_ / _` | |_  / |
|  _| (_| | |/ /| |                               |_|  \__,_|_/___|_|
    print ' [1] START'
    print ' [2] FOLLOW faizibou ON FB '
    print ' [3] OWNER (😈) Faizi'
    print ' [4] WHATSAPP  (🔥)03117826879'
    print ''
    menu_option()
